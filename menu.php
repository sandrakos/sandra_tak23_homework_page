        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="index.php?page=read"><i class="fa-solid fa-book-open text-primary"></i> Read</a> <!-- Mõlemat moodi saab kirutada -->
                    ...
                    <a class="nav-link" href="index.php?page=homework"><i class="fa-solid fa-school"></i> Homework</a>
                </div>
            </div>
        </div>
    </nav>
